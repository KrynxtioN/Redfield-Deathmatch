...
addEventHandler("onClientRender", root,
    function()
		if(getElementData(localPlayer,"loggedin") == 1)then
			...
			dxDrawText(getElementData(localPlayer,"GDMCoins"), 1790*(x/1920), 123*(y/1020), 1903*(x/1920), 139*(y/1020), tocolor(74, 152, 4, 255), 1.00, ScoreboardFont2, "left", "center", false, false, false, false, false)
