...
addEventHandler("onClientRender", root,
    function()
		if(getElementData(localPlayer,"loggedin") == 1 and Tutorial.active ~= true)then
			...
			dxDrawText(getPedAmmoInClip(localPlayer).." - "..getPedTotalAmmo(localPlayer) - getPedAmmoInClip(localPlayer), 1617*(x/1920), 98*(y/1020), 1683*(x/1920), 114*(y/1020), tocolor(255, 255, 255, 255), 1.00, "default-bold", "center", "center", false, false, false, false, false)
			...
			dxDrawText(monthday.."."..month.."."..year.." - "..hour..":"..minute.." Uhr", 1718*(x/1920), 20*(y/1020), 1900*(x/1920), 36*(y/1020), tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", false, false, false, false, false)
			dxDrawText(Zone, 1718*(x/1920), 46*(y/1020), 1900*(x/1920), 62*(y/1020), tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "center", false, false, false, false, false)
			...
			dxDrawText(math.floor(Armor).."%", 1718*(x/1920), 72*(y/1020), 1900*(x/1920), 88*(y/1020), tocolor(255, 255, 255, 255), 1.00, "default-bold", "center", "center", false, false, false, false, false)
			dxDrawText(math.floor(Health).."%", 1718*(x/1920), 98*(y/1020), 1900*(x/1920), 114*(y/1020), tocolor(255, 255, 255, 255), 1.00, "default-bold", "center", "center", false, false, false, false, false)
			dxDrawImage(1617*(x/1920), 123*(y/1020), 15*(x/1920), 16*(y/1020), "Files/Images/HUD/money.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
			dxDrawText("$"..Money, 1642*(x/1920), 123*(y/1020), 1755*(x/1920), 139*(y/1020), tocolor(74, 152, 4, 255), 1.20, "default-bold", "left", "center", false, false, false, false, false)
			...
			dxDrawText(getElementData(localPlayer,"GDMCoins"), 1790*(x/1920), 123*(y/1020), 1903*(x/1920), 139*(y/1020), tocolor(74, 152, 4, 255), 1.20, "default-bold", "left", "center", false, false, false, false, false)
			...
			if(getElementData(localPlayer,"Lobby") == "TacticsArena")then
				...
				dxDrawText("Angels of Death\n"..AoDPlayersNotDead.."/"..AoDPlayers, 1607*(x/1920), 163*(y/1020), 1755*(x/1920), 200*(y/1020), tocolor(255, 255, 255, 255), 1.00, "default-bold", "center", "center", false, false, false, false, false)
				dxDrawText("Yakuza\n"..YakuzaPlayersNotDead.."/"..YakuzaPlayers, 1762*(x/1920), 163*(y/1020), 1910*(x/1920), 200*(y/1020), tocolor(255, 255, 255, 255), 1.00, "default-bold", "center", "center", false, false, false, false, false)
			end
			if(getElementData(localPlayer,"Lobby") ~= "Eingangshalle" and getElementData(localPlayer,"SpectatormodeAktiv") ~= true)then
				...
				dxDrawText(getElementData(localPlayer,"TemporaererDamage"), 1638*(x/1920), 216*(y/1020), 1707*(x/1920), 233*(y/1020), tocolor(255, 255, 255, 255), 1.00, "default-bold", "center", "center", false, false, false, false, false)
				dxDrawImage(1717*(x/1920), 216*(y/1020), 14*(x/1920), 17*(y/1020), "Files/Images/HUD/skull.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
				dxDrawText(getElementData(localPlayer,"TemporaererKill"), 1741*(x/1920), 216*(y/1020), 1810*(x/1920), 233*(y/1020), tocolor(255, 255, 255, 255), 1.00, "default-bold", "center", "center", false, false, false, false, false)
				dxDrawImage(1820*(x/1920), 216*(y/1020), 15*(x/1920), 17*(y/1020), "Files/Images/HUD/time.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
				dxDrawText(time, 1845*(x/1920), 216*(y/1020), 1900*(x/1920), 233*(y/1020), tocolor(255, 255, 255, 255), 1.00, "default-bold", "center", "center", false, false, false, false, false)
			end
		end
    end
)